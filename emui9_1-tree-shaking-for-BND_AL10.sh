...
#com.android.providers.userdictionary # 用户字典, 不可删, 设置会闪退
...
adb shell pm uninstall --user 0 com.huawei.contacts.sync # 联系人同步
...
adb shell pm uninstall --user 0 com.honor.club # 荣耀俱乐部
...
adb shell pm uninstall --user 0 com.huawei.hicard # 卡片服务
adb shell pm uninstall --user 0 com.huawei.nearby # 附近
adb shell pm uninstall --user 0 com.sankuai.meituan # 美团
adb shell pm uninstall --user 0 com.huawei.hnreader # 阅读
adb shell pm uninstall --user 0 com.huawei.search # 搜索
adb shell pm uninstall --user 0 com.huawei.hiview # 日志
...
adb shell pm uninstall --user 0 com.hihonor.vmall # 荣耀商城
adb shell pm uninstall --user 0 com.tencent.mtt # QQ浏览器
adb shell pm uninstall --user 0 com.ss.android.article.news # 今日头条
adb shell pm uninstall --user 0 com.huawei.hwstartupguide # 首次开机引导
adb shell pm uninstall --user 0 com.baidu.BaiduMap # 百度地图
adb shell pm uninstall --user 0 com.huawei.android.hwpay # 华为钱包安全支付
adb shell pm uninstall --user 0 com.tencent.news # 腾讯新闻
...
adb shell pm uninstall --user 0 com.huawei.android.karaoke # K歌特效
adb shell pm uninstall --user 0 com.huawei.bd # 用户为体验改进计划
